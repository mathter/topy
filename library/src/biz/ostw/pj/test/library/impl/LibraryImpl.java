/**
 */
package biz.ostw.pj.test.library.impl;

import biz.ostw.pj.test.library.Author;
import biz.ostw.pj.test.library.Book;
import biz.ostw.pj.test.library.Library;
import biz.ostw.pj.test.library.LibraryPackage;
 ...
 * </p>
 * <ul>
 *   <li>{@link biz.ostw.pj.test.library.impl.LibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link biz.ostw.pj.test.library.impl.LibraryImpl#getAuthors <em>Authors</em>}</li>
 *   <li>{@link biz.ostw.pj.test.library.impl.LibraryImpl#getBooks <em>Books</em>}</li>
 * </ul>
 *
 * @generated
 */
