/**
 */
package biz.ostw.pj.test.library.provider;


import biz.ostw.pj.test.library.Library;
import biz.ostw.pj.test.library.LibraryFactory;
...
/**
 * This is the item provider adapter for a {@link biz.ostw.pj.test.library.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAuthorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Library_authors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Library_authors_feature", "_UI_Library_type"),
